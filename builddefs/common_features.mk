...
ifneq (,$(filter $(MCU), atmega16u2 atmega32u2 at90usb162))
    ...
    OPT_DEFS += -DSNLED27351 -DSTM32_SPI
	SPI_DRIVER_REQUIRED = yes
        COMMON_VPATH += $(DRIVER_PATH)/led/snled
...
VALID_RGB_MATRIX_TYPES := aw20216 is31fl3731 is31fl3733 is31fl3736 is31fl3737 is31fl3741 is31fl3742a is31fl3743a is31fl3745 is31fl3746a ckled2001 snled27351 snled27351_spi ws2812 custom
